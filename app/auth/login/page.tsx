...
import { Loader2, Plane, ArrowLeft, Mail, Lock } from 'lucide-react'
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-md">
              Your next adventure awaits. Sign in to continue planning your perfect trip with AI-powered recommendations.
            </p>
          </motion.div>
          ...
          />
          <motion.div
            className="absolute top-40 right-40 w-32 h-32 rounded-full bg-accent/20 blur-2xl"
